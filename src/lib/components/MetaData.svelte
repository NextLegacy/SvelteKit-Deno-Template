...
<svelte:head>
	...
	{#if page.data.metadata?.meta?.viewport || metadata.meta?.viewport}
		<meta name="viewport" content={page.data.metadata?.meta?.viewport ?? metadata.meta.viewport} />
	{/if}
	...
	{#if page.data.metadata?.meta?.msapplication_config || metadata.meta?.msapplication_config}
		<meta
			...
			content={page.data.metadata?.meta?.msapplication_config ?? metadata.meta.msapplication_config}
		/>
	{/if}
	{#if page.data.metadata?.meta?.canonical || metadata.meta?.canonical}
		<link rel="canonical" href={page.data.metadata?.meta?.canonical ?? metadata.meta.canonical} />
	{/if}
	...
	{#if page.data.metadata?.meta?.og || metadata.meta?.og}
		...
		{#if page.data.metadata?.meta?.og?.url || metadata.meta?.og?.url}
			<meta property="og:url" content={page.data.metadata?.meta?.og?.url ?? metadata.meta.og.url} />
		{/if}
		...
		{#if page.data.metadata?.meta?.og?.image || metadata.meta?.og?.image}
			...
			{#if page.data.metadata?.meta?.og?.image?.width || metadata.meta?.og?.image?.width}
				<meta
					...
					content={page.data.metadata?.meta?.og?.image?.width ?? metadata.meta.og.image.width}
				/>
			{/if}
			{#if page.data.metadata?.meta?.og?.image?.height || metadata.meta?.og?.image?.height}
				<meta
					property="og:image:height"
					content={page.data.metadata?.meta?.og?.image?.height ?? metadata.meta.og.image.height}
				/>
			{/if}
		{/if}
	{/if}
	{#if page.data.metadata?.meta?.twitter || metadata.meta?.twitter}
		...
		{#if page.data.metadata?.meta?.twitter?.creator || metadata.meta?.twitter?.creator}
			<meta
				...
				content={page.data.metadata?.meta?.twitter?.creator ?? metadata.meta.twitter.creator}
			/>
		{/if}
		...
		{#if page.data.metadata?.meta?.twitter?.image || metadata.meta?.twitter?.image}
			<meta
				name="twitter:image"
				content={page.data.metadata?.meta?.twitter?.image?.url ?? metadata.meta.twitter.image.url}
			/>
			{#if page.data.metadata?.meta?.twitter?.image?.alt || metadata.meta?.twitter?.image?.alt}
				<meta
					name="twitter:image:alt"
					content={page.data.metadata?.meta?.twitter?.image?.alt ?? metadata.meta.twitter.image.alt}
				/>
			{/if}
		{/if}
	{/if}
